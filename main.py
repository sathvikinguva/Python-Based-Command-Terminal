"""
PyTerm - Python-Powered Terminal
Assignment Entry Point

This is the main entry point for the PyTerm assignment.
Provides both local CLI interface and web terminal functionality.
"""
...
def main():
    """Main entry point for assignment submission."""
    import argparse
    ...
    parser.add_argument('--web', action='store_true', 
                       help='Show web terminal information')
    ...
    # Show web terminal info if requested
    if args.web:
        console = Console()
        console.print(Panel.fit(
            "[bold cyan]PyTerm Web Terminal[/bold cyan]\\n"
            "🌐 Live Demo: [blue]https://pytem.vercel.app/[/blue]\\n"
            "📚 GitHub: [blue]https://github.com/sathvikinguva/Python-Based-Command-Terminal[/blue]\\n"
            "💻 Local CLI: [green]python main.py[/green]"
        ))
        return 0
